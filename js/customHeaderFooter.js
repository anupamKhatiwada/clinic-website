  ...
  constructor() {
    ...
    this.innerHTML = `
      ...
      <div class="logo-container">
        <img src="/clinic-website/images/logo.png" class="dental-logo" alt="GMDC" />
      </div>
    ...
    <div class="address-phone">
      ADDRESS
      <p>
        <img src="/clinic-website/images/location.svg" class="address-phone-logo" />CLINIC
        LOCATION
      </p>
    </div>
    ...
    <div class="address-phone">
      CALL US
      <p>
        <img src="/clinic-website/images/phone.svg" class="address-phone-logo" /><a href="tel:+919436333040">9436333040</a>
      </p>
    </div>
  </div>
